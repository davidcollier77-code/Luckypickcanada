...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 space-y-12 max-w-6xl mx-auto">
      ...
      {/* Card Reveal Section (Replaces Lucky Blackjack) */}
      ...
      {/* Lucky Journey & Personalized Picks Section */}
      ...
      {/* Lucky Stories & Canada Map Section */}
