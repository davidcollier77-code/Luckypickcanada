  ...
  return (
    <section id="lucky-blackjack-challenge" className="lucky-blackjack premium-surface" aria-labelledby="lucky-blackjack-title">
      ...
      <div className="blackjack-content">
        <div className="experience-brand"><Image src="/lucky-pick-canada-logo.png" alt="LuckyPickCanada official maple clover logo" width={52} height={52} sizes="52px" quality={90} /><span>LuckyPickCanada.ca</span></div>
