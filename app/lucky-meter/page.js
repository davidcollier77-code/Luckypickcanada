...
export default function LuckyMeterPage() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#03060d] text-slate-100 flex flex-col justify-between selection:bg-amber-500/30">
      ...
      <div
        className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[420px] h-[420px] rounded-full bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-amber-400/15 via-indigo-950/20 to-transparent blur-3xl z-[1]"
      />
