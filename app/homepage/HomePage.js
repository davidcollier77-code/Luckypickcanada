...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      drawAuroraCurtain(0, height * 0.45, '24, 208, 150', 0.25, height * 0.25, 0.3, -15);

      // 2. Secondary Emerald curtain, lower, overlapping, opposite diagonal
      drawAuroraCurtain(2.5, height * 0.55, '16, 185, 129', 0.20, height * 0.3, 0.25, 10);

      // 3. Deep Blue/Purple curtain, higher up, very diffuse atmospheric glow
      drawAuroraCurtain(4.2, height * 0.35, '90, 70, 200', 0.15, height * 0.35, 0.2, -5);

      // 4. Cyan highlight band, steeper angle, slightly faster drifting
      drawAuroraCurtain(1.5, height * 0.6, '45, 200, 190', 0.28, height * 0.2, 0.35, -25);
