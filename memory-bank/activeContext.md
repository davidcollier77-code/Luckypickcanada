...
- Verification so far: the branch is exactly one commit ahead of `main`; compare reports one changed application file with 3 additions and 4 deletions. User-facing runtime playback still requires a fresh rendered capture after this change.
